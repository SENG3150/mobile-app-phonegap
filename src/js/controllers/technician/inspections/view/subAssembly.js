angular
	.module('joy-global')
	.controller('TechnicianInspectionsViewControllerSubAssembly', ['$scope', '$stateParams', 'moment', 'InspectionsStorage', 'LayoutService', 'DomainExpertsStorage', 'TechniciansStorage', function ($scope, $stateParams, moment, InspectionsStorage, LayoutService, DomainExpertsStorage, TechniciansStorage) {
		...
		$scope.takePhoto = function (input) {
			switch (input) {
				case 'oil':
					navigator.camera.getPicture(saveOilPhotos, onFail, {
						quality: 50,
						destinationType: Camera.DestinationType.DATA_URL
					});
					break;
				case 'machine':
					navigator.camera.getPicture(saveMachinePhotos, onFail, {
						quality: 50,
						destinationType: Camera.DestinationType.DATA_URL
					});
					break;
				case 'wear':
					navigator.camera.getPicture(saveWearPhotos, onFail, {
						quality: 50,
						destinationType: Camera.DestinationType.DATA_URL
					});
					break;
